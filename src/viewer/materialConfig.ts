...
export function createTf2Uniforms() {
  return {
    ...
    uTf2StickerTl: { value: new THREE.Vector2() },
    uTf2StickerTr: { value: new THREE.Vector2(1, 0) },
    uTf2StickerBl: { value: new THREE.Vector2(0, 1) },
    uTf2StickerCenter: { value: new THREE.Vector2(0.5, 0.5) },
    uTf2StickerOpacity: { value: 1 },
